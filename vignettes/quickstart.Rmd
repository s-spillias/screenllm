...
also accepts CSV or XLSX paths and normalises common column-name
variations (Scopus, Web of Science, EndNote). The package ships with a
30-record toy dataset drawn from the *Habitat Effect* review used in the
manuscript, which we use here for demonstration.
...
criteria <- define_criteria(
  scope = "Studies that test how surrounding natural habitat influences fish assemblages on artificial reefs",
  inclusions = c(
    "The study is conducted in a marine or estuarine environment.",
    "The study examines fish assemblages or fish performance associated with artificial reefs.",
    "The surrounding natural habitat is treated as a predictor (independent variable) of the response.",
    "The study reports fish responses interpreted as artificial-reef performance."
  )
)
print(criteria)
```
